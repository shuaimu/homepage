...
The guidelines for this part will be released after the class enrollment list is finalized. Before that you can view the lab content in its original repo [here](https://github.com/stonysystems/dslabs-cpp).
